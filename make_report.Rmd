...
knit: (
  function(inputFile, encoding) { 
    ...
    file_title <- 'Report - Measuring parental user experience with the NCMP letters'
...
knitr::include_graphics(here("all_plots/report/dag_updated_m1_UEQ.png"))
```
...
knitr::include_graphics(here("all_plots/report/correlation_categorical.png"))
```
...
knitr::include_graphics(here("all_plots/report/pre_post_levels_merged.png"))
```
...
knitr::include_graphics(here("all_plots/report/predictors_UEQ_Attractiveness_vars.png"))
```
...
knitr::include_graphics(here("all_plots/report/aicbic_UEQ_Attractiveness_mod.png"))
```
...
knitr::include_graphics(here("all_plots/report/diagnostic_1_UEQ_Attractiveness.png"))
```
...
knitr::include_graphics(here("all_plots/report/diagnostic_2_UEQ_Attractiveness.png"))
```
...
knitr::include_graphics(here("all_plots/report/final_vis_UEQ_Attractiveness.png"))
```
